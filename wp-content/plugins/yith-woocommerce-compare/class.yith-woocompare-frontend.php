    ...
    class YITH_Woocompare_Frontend {
                    ...
                    switch( $field ) {
                        ...
                        case 'stock':
                            ...
                            if ( empty( $availability['availability'] ) ) {
                                $availability['availability'] = __( 'В наличии', 'yit' );
                            }
        ...
        public function add_compare_link( $product_id = false, $args = array() ) {
            ...
            if ( ! isset( $button_text ) || $button_text == 'default' ) {
                $button_text = get_option( 'yith_woocompare_button_text', __( 'Сравнить', 'yit' ) );
        ...
        public function list_products_html( $lang = false ) {
            ...
            if ( empty( $this->products_list ) ) {
                echo '<li>' . __( 'Выберите товары, которые хотите сравнить', 'yit' ) . '</li>';
                return ob_get_clean();
            }
            ...
            foreach ( $this->products_list as $product_id ) {
                ...
                <li>
                    ...
                    <a href="<?php echo $this->remove_product_url( $product_id ) ?>" data-product_id="<?php echo $product_id; ?>" class="remove" title="<?php _e( 'Удалить', 'yit' ) ?>">x</a>
                </li>
            <?php
            }
