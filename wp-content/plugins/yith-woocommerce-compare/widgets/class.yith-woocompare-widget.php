...
if( !class_exists( 'YITH_WOOCOMPARE' ) ) {
    ...
    class YITH_Woocompare_Widget extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            <a href="<?php echo $yith_woocompare->obj->remove_product_url('all') ?>" data-product_id="all" class="clear-all"><?php _e( 'Очистить', 'yit' ) ?></a>
            <a href="<?php echo add_query_arg( array( 'iframe' => 'true' ), $yith_woocompare->obj->view_table_url() ) ?>" class="compare button"><?php _e( 'Сравнить', 'yit' ) ?></a>
