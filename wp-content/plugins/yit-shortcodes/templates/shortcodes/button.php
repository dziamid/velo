...
if ( isset( $icon ) && $icon != '' && $icon != 'None' ) {
    ...
    if ( isset( $animation ) && $animation != '' ) {
        $html = '<a id="' . $id . '" href="' . $href . '" ' . $target . ' class="btn animated ' . $animation . ' ' . $dimension . ' ' . $animate . ' ' . $color . ' ' . $class . ' fa fa-' . $icon . '" ' . $animate_data . ' ><span>' . $content . '</span></a>';
    }
    else {
        $icon = '<i class="fa fa-' . $icon . '" ' . $icon_size . '></i>';
        $html = '<a id="' . $id . '" href="' . $href . '" ' . $target . ' class="btn ' . $dimension . ' ' . $color . ' ' . $class . '">' . $icon . ' ' . $content . '</a>';
    }

}
else {
    $html = '<a id="' . $id . '" href="' . $href . '" ' . $target . ' class="btn ' . $dimension . ' ' . $animate . ' ' . $color . ' ' . $class . '" ' . $animate_data . '  >' . $content . '</a>';
}
?>
<?php echo $html; ?>