...
$animate = ( $animate != '' ) ? ' yit_animate ' . $animate : '';
 ?>
<div class="google-map-frame  <?php echo $animate ?>" <?php echo $animate_data ?> style="<?php if ($width != '' && $height != '') : ?>width: <?php echo $width; ?>px; height: <?php echo $height; ?>px;<?php else: echo 'width: auto; height: '.$height; endif; ?> ">
