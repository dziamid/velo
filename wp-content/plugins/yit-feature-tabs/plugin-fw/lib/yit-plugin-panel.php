...
if ( ! class_exists( 'Yit_Plugin_Panel' ) ) {
    ...
    class Yit_Plugin_Panel {
        ...
        public function add_setting_page() {
            add_submenu_page( 'edit.php?' . $this->settings['parent_page'], __( 'Plugin Settings', 'yit' ), __( 'Settings', 'yit' ), 'manage_options', $this->settings['page'], array( &$this, 'yit_panel' ) );
        }
        ...
        function render_field( $param ) {
            ...
            if ( ! empty( $param ) && isset( $param ['option'] ) ) {
                ...
                if ( file_exists( $type ) ) {
                    ...
                    include $type = YIT_CORE_PLUGIN_PATH . '/templates/panel/types/text.php';
                }
            }
        }
