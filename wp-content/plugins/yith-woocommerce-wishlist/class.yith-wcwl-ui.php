...
public static function popup_message() {
    ...
    public static function add_to_wishlist_button( $url, $product_type, $exists ) {
        ...
        $html .= '<div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;"><span class="feedback">' . __( 'Товар добавлен!','yit' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Мой список желаний', 'yit' ) ) . '</a></div>';
        $html .= '<div class="yith-wcwl-wishlistexistsbrowse ' . ( $exists ? 'show' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"><span class="feedback">' . __( 'Товар уже добавлен в список ваших желаний!', 'yit' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Мой список желаний', 'yit' ) ) . '</a></div>';
    ...
    public static function get_share_links( $url ) {
        ...
        $html .= apply_filters( 'yith_wcwl_socials_share_title', '<h4>' . __( 'Поделиться в:', 'yit' ) . '</h4>' );
        $html .= '<ul>';
