...
class YIT_Contact_Form {
    ...
    public function shortcode_callback( $atts, $content = null, $shortcode ) {
        ...
        ob_start();
        yit_plugin_get_template($this->plugin_path, './contact-form/contactform-template.php', array('fields'=>$fields, 'post_id'=>$this->current_form_id, 'button_style' => $all_atts['button_style'], 'title_position' => $this->get( '_title_position' ) ) );
