...
extract( array(
    ...
    'autoplay_speed' => $slider->get( 'config-autoplay_speed' )
) );
...
<div id="<?php echo $slider_id ?>" <?php $slider->item_class( $slider_class ) ?> data-pagination="<?php echo $pagination  ?>" data-height="<?php echo $height  ?>" style="height: <?php echo $height  ?>px;" <?php echo ( $autoplay ) ? ( 'data-autoplay="' . $autoplay_speed . '"' ) : ''; ?>>
