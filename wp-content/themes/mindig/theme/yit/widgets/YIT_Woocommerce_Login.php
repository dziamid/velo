           ...
           // var_dump($instance);
                ...
                <div id="welcome-menu" class="nav dropdown">
                    <ul>
                        <li class="menu-item dropdown">
                            <a class="hidden-xs" href="#"><span class="welcome_username"><?php echo apply_filters( 'yit_welcome_login_label', __('Здравствуйте', 'yit') ); ?> <b> <?php  echo apply_filters( 'yit_welcome_username', ', ' . $user_name ) ?></b></span> </a>
            ...
            if( $nav_show_wishlist ): ?>
                <div class="nav whislist_nav">
                    <ul>
                        <li>
                            <a href="<?php echo wc_get_endpoint_url('wishlist', '',  get_permalink( wc_get_page_id( 'myaccount' ) ) ) ?>"><?php  _e('Список моих желаний', 'yit') ?></a>
                        </li>
                    </ul>
                </div>
            <?php endif;
