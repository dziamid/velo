...
<?php
    ...
    if( isset($icon) && $icon != '' && $icon != 'None' ) {
        ...
        if(isset($animation) && $animation != '') {
            $html = '<a id="'. $id .'" href="' . $href . '" ' . $target . ' class="btn animated '.$animation.' '. $dimension .' '.$animate. ' ' . $color . ' ' . $class . ' fa fa-'.$icon.'" '. $delay .' ><span>' . $content . '</span></a>';
        }
        else {
		...
		$html = '<a id="'. $id .'" href="' . $href . '" ' . $target . ' class="btn ' . $dimension . ' ' . $animate . ' ' . $color . ' ' . $class . '" '. $delay .'  >' . $content . '</a>';
	}
?>
<?php echo $html; ?>