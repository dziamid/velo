...
switch ( $border ):
    case 'middle':
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate ?> box-title-line-middle wrap-title <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $delay ?>>
            <div class="title-bar">
