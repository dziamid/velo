            ...
            foreach($values as $k => $value) : ?>
                <li>
                    <label class="radio-inline">
                        <input type="checkbox" name="<?php yit_field_name( $id ); ?>[<?php echo $i?>][]" value="<?php echo $k; ?>" <?php if( isset( $option[$i] ) && is_array( $option[$i] ) ) checked( in_array( $k, $option[$i] ) ); ?> id="<?php echo( $id ); ?>-<?php echo $value ?>" class="checkbox" />&nbsp;
                        <?php echo $value; ?>
                    </label>
                </li>
            <?php endforeach;  ?>
