    ...
    <div class="option">
        ...
        <?php if( in_array($default_css_style_selectors['size'], $require_style_css_selectors  ) ) : ?>
            ...
            <div class="spinner_container">
                <input class="typography_size number" type="text" name="<?php yit_field_name( $id ) ?>[size]" id="<?php echo $id ?>-size" value="<?php echo $std['size'] ?>" data-min="<?php if(isset( $min )) echo $min ?>" data-max="<?php if(isset( $max )) echo $max ?>" />
            </div>
        ...
        <?php if( in_array($default_css_style_selectors['color'], $require_style_css_selectors  ) ) : ?>
            ...
            <div id="<?php echo $id ?>_container" class="typography_color colorpicker_container">
                <input type="text" name="<?php yit_field_name( $id ) ?>[color]" id="<?php echo $id ?>-color" value="<?php echo $std['color'] ?>" style="width:75px" data-default-color="<?php echo $std_color ?>" class="medium-text code panel-colorpicker" />
            </div>
        <?php endif; ?>
