    ...
    foreach ($cats as $cat) {
      ...
      query_posts('posts_per_page=-1&cat='.$cat->cat_ID); //-1 показывать все статьи категории. 1 показывать последние статьи.
         ...
         $category = get_the_category();
            ...
            <li><?php the_time('M d, Y')?> &raquo; <a href="<?php the_permalink() ?>"  title="Перейти по ссылке: <?php the_title(); ?>">
...
{width: 500px; padding:0 0 0 0; margin: 0;}
div.wpsc_buy_button_container
{width: 200px;}
div.additional_description_container
{width: 500px; padding:0 0 0 0; margin: 0; text-align: justify;}
h3.notprod
{width: 400px;}
div.wpsc_page_numbers_top
{width: 400px;}
div.wpsc_default_product_list
{width: 400px;}
div.productcol {width: 400px;}
div.wrap_wpsc_container {width: 400px;}
</style>
</div>
			</div><!-- #content -->
		</div><!-- #container -->
