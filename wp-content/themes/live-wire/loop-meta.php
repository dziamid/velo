...
?>
	...
	<?php elseif ( is_search() ) : ?>
		...
		<div class="loop-meta">
			...
			<div class="loop-description">
				<p>
				<?php printf( __( 'Результаты поиска "%s"', 'live-wire' ), esc_attr( get_search_query() ) ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_date() ) : ?>
		...
		<div class="loop-meta">
			<h1 class="loop-title"><?php _e( 'Архивы по дате', 'live-wire' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'Вы просматриваете архивы сайта по дате', 'live-wire' ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_archive() ) : ?>
		...
		<div class="loop-meta">
			...
			<h1 class="loop-title"><?php _e( 'Архивы', 'live-wire' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'Вы просматриваете архивы сайта.', 'live-wire' ); ?>
				</p>
			</div><!-- .loop-description -->
