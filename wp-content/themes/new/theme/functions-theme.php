...
function yit_check_single_product_layout(){
    ...
    if ( yit_get_option( 'shop-single-layout-page' ) == 'creative' && !$is_quick_view && !YIT_Mobile()->isMobile()) {
        ...
        if ( yit_get_option('shop-enable') == 'yes' && yit_get_option('shop-single-product-price') == 'yes' ) add_action( 'yit_product_box', 'woocommerce_template_single_price', 10 );
        if ( yit_get_option('shop-enable') == 'yes' && yit_get_option('shop-single-add-to-cart') == 'yes' ) add_action( 'yit_product_box', 'woocommerce_template_single_add_to_cart', 20 );
