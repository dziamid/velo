...
<div class="cart-empty col-sm-12">
    ...
    <?php echo do_shortcode('[products_slider per_page="12" hide_free="no" show_hidden="no" animation_delay="0" category="null" layout="default" product_type="all" orderby="rand" order="desc" autoplay="true" animate="" ]')?>
