...
<div id='footer'>
		...
		<div class='footer_txt'>
			<div class='container'>
				...
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/ladiesjournal/' target='_blank'>Elegant WordPress themes</a>, thanks to: <a href='http://wpdis.co/free/sciencepress/' target='_blank'>Free education WordPress themes</a>, <a href='http://nachild.com/us-fights-to-adopt-russian-kids/' target='_blank'>Russian Kids</a> and <a href='http://fthe.me/newsroom-responsive-news-magazine-theme/' target='_blank'>WordPress magazine theme</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
